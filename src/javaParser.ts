import { JavaClass, JavaField } from './utils/types';
 ...
 */
export function parseJavaClass(javaCode: string): JavaClass[] {
 ...
 */
function extractFields(classBody: string): JavaField[] {
    ...
    while ((fieldMatch = fieldRegex.exec(classBody)) !== null) {
        ...
        const annotationSection = classBody.substring(
            Math.max(0, fieldMatch.index - 200), 
            fieldMatch.index
        );
 ...
 */
export function analyzeFieldSemantics(field: JavaField): string[] {
